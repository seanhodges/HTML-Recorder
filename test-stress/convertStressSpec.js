...
describe('stress test GET', function() {
    it('should generate a poster via a GET', function (done) {
        superagent
            .get('http://uk-office.wav2.com:17142/convert/test.png?src=http://localhost/MNN487118_Test/Entertainment1+300+x+250.html&width=300&height=250')
...
describe.only('stress test POST', function() {
    it('should generate a poster via a POST', function (done) {
        superagent
            .post('http://uk-office.wav2.com:17142/convert/test.png')
            .type('form')
